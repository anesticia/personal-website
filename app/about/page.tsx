  ...
  return (
    <>
      ...
      <section className="about-grid section-pad">
        <Reveal className="about-image"><Image src="/images/numerical-methods.png" alt="Six numerical methods compared on the same reaction–diffusion system" fill sizes="(max-width: 900px) 100vw, 48vw" /></Reveal>
