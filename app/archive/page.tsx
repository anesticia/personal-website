  ...
  return (
    <>
      <header className="atlas-page-hero atlas-archive-hero">
        <div className="atlas-archive-hero-copy"><p className="atlas-kicker">Research archive · {String(works.length).padStart(2, "0")} records</p><h1>Work, experiments, and <em>open questions.</em></h1><p>{works.length} records. Open one to see the current evidence, limits, and what remains unresolved.</p></div>
