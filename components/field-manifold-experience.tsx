...
const projectRecords: ProjectRecord[] = [
  ...
  { slug:"orbit-pinn", code:"SP", short:"Shared structure-preserving local flow", source:"Local paper artifacts", stage:"Active research", methods:["PINN","Autodiff","Fourier features","Invariants"], concepts:["Lorentz dynamics","rolling windows","hard continuity"], accent:"#f5b85b", field:[73,66], terrain:[.45,-.58,.72], coordinates:{domain:[72,66,.9],method:[53,23,.86],evidence:[68,42,.84]} },
...
const evidenceRegister = [
  ...
  { slug: "orbit-pinn", question: "Can one shared local flow preserve useful dynamics across three magnetic-field families?", reference: "Boris trajectories plus phase, turn, bounce, azimuth, and RMSE diagnostics", boundary: "V4 shows limited feasibility; the V5 pilot failed and V4.5 remains incomplete." },
...
function CurvatureAtlas() {
  ...
  return <div className="fm-page fm-curvature"><FamilyDock active="curvature-atlas" /><FamilyHeader dark label="Portfolio topology / drag to inspect relationships" />
    <main className="curvature-stage"><section className="curvature-intro"><small>Curvature Atlas / 04 research records</small><h1>Research has<br /><em>terrain.</em></h1><p>The surface maps what each project is, not how good it is: computational orientation, working context, and artifact scope.</p><a href="#evidence-register">Compare the evidence <ArrowIcon /></a></section>
...
export function FieldManifoldIndex() {
  return <div className="fm-page fm-index"><FamilyDock/><FamilyHeader dark label="Derived from Physics Atlas 02 + 04" />
    ...
    <footer><p>Built from four verified portfolio records across local repositories, private GitHub repositories, and one public journal article.</p><Link href="/archive">Open canonical archive <ArrowIcon/></Link></footer>
  </div>;
}
