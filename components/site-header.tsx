...
export function SiteHeader() {
  ...
  return (
    <header className="site-header atlas-site-header">
      <svg className="nav-island-geometry" viewBox="0 0 1320 68" preserveAspectRatio="none" aria-hidden="true">
        ...
        <path className="nav-island-trace" d="M244 49C401 45 520 53 665 49C808 45 936 53 1084 48" />
      </svg>
